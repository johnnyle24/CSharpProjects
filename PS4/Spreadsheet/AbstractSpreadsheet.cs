...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// For each string returned from the list of dependees, it checks if the start string is repeated.
        /// If it is, an exception is thrown. If not, if the string hasn't already been added,
        /// it is added to the list of visited.
        /// </summary>
